...
@implementation DisplayPaneController
...
- (id) init
{
	...
	image = [[NSImage alloc] initWithContentsOfFile: [bundle pathForResource: @"Display" ofType: @"tiff" inDirectory: @""]];
	nib = @"Display";
	aTitle = @"Display";
 ...
 */
	usleep ( 100000 );
	NSLog ( @"Display preferences module interface loaded." );
/*
 * DO NOT REMOVE THIS!!
 */
