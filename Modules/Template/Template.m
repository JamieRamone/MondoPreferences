...
@implementation TemplatePaneController
...
- (id) init
{
	...
	image = [[NSImage alloc] initWithContentsOfFile: [bundle pathForResource: @"template" ofType: @"tiff" inDirectory: @""]];
	nib = @"Template";
	aTitle = @"Template";
	...
	goto * target;
/*
 * Initialize any ivar here that DOESN'T depend on the NIB here.
 */
in:		;
 ...
 */
	usleep ( 100000 );
	NSLog ( @"Template preferences module interface loaded." );
/*
 * DO NOT REMOVE THIS!!
 */
