...
@interface UnixExpertPaneController : PreferencePaneController {
	id	umaskMatrix;
	id	unixExpertCheckbox;
	id	largeFileSystemCheckbox;
	id	privateWindowServerCheckbox;
	id	privateSoundServerCheckbox;
	id	protectedEPSDisplayCheckbox;
}
